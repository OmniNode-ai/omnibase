...
```json
{
  ...
  "documentation_url": "https://docs.omninode.ai/errors/SC002"
}
```
...
ERROR [SC002]: Schema validation failed
  ...
  Details: Field 'lifecycle' is required but missing
  Suggestion: Add 'lifecycle: active' to metadata block
  Documentation: https://docs.omninode.ai/errors/SC002
```
...
ERROR [LC005]: Deprecated node missing replacement
  ...
  Documentation: https://docs.omninode.ai/errors/LC005
```
...
ERROR [RG005]: .onextree out of sync
  ...
  Suggestion: Run 'onex tree generate' to update manifest
  Documentation: https://docs.omninode.ai/errors/RG005
```
