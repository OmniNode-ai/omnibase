...
# name: "yaml_validate_metadata_block"
# namespace: "omninode.tools.yaml_validate_metadata_block"
# meta_type: "model"
# version: "0.1.0"
...
# entrypoint: "yaml_validate_metadata_block.py"
# protocols_supported:
#   - "["O.N.E. v0.1"]"
# protocol_class:
...
"""
YamlValidateMetadataBlock: YAML-specific metadata block validator implementing ProtocolValidateMetadataBlock.

This validator enforces metadata block compliance for YAML files, including:
...
class YamlValidateMetadataBlock(ProtocolValidateMetadataBlock):
    """YAML-specific metadata block validator implementing ProtocolValidateMetadataBlock."""
