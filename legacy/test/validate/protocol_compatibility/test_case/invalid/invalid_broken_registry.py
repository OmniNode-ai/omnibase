...
# name: "invalid_broken_registry"
# namespace: "omninode.tools.invalid_broken_registry"
# meta_type: "model"
# version: "1.0.0"
...
# entrypoint: "invalid_broken_registry.py"
# protocols_supported:
#   - "["O.N.E. v0.1"]"
# protocol_class:
#   - '['ProtocolValidate']'
...
"""
Test case for a broken registry.
This test case verifies that the protocol compatibility validator
correctly handles a broken registry.
"""
...
class BrokenRegistryValidator(ProtocolValidate):
    """A validator that works with a broken registry."""
    ...
    def get_name(self) -> str:
        ...
        return "broken_registry_validator"
    ...
    def metadata(cls):
        ...
        return {
            "metadata_version": "0.1",
            "name": "broken_registry_validator",
            "namespace": "omninode.tools.invalid_broken_registry",
            "version": "1.0.0",
            "entrypoint": "invalid_broken_registry.py",
            ...
            "created_at": "2025-05-07T12:00:00+00:00",
            "last_modified_at": "2025-05-07T12:00:00+00:00",
            "description": "A validator that works with a broken registry.",
            "tags": ["test", "broken"],
            "dependencies": [],
            "config": {}
        } 