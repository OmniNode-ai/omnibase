...
# name: "invalid_metadata_stamper_missing_entries"
# namespace: "omninode.tools.invalid_metadata_stamper_missing_entries"
# meta_type: "test"
# version: "0.1.0"
...
# entrypoint: "invalid_metadata_stamper_missing_entries.py"
...
"""
Test case for missing registry entries in metadata stamper.
This file is used to test that the metadata stamper properly handles missing registry entries.
"""
...
def get_template_registry():
    ...
    registry = MetadataRegistryTemplate()  # Empty registry
    return registry
