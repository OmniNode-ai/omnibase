...
# name: "invalid_metadata_stamper_large_file"
# namespace: "omninode.tools.invalid_metadata_stamper_large_file"
# meta_type: "test"
# version: "0.1.0"
...
# entrypoint: "invalid_metadata_stamper_large_file.py"
...
"""
Test case for large file handling in metadata stamper.
This file is used to test that the metadata stamper properly handles large files.
"""
...
def get_test_file():
    ...
    return "# " + "x" * (10 * 1024 * 1024)  # 10MB of comments 