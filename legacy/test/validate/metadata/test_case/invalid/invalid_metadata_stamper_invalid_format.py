...
# name: "invalid_metadata_stamper_invalid_format"
# namespace: "omninode.tools.invalid_metadata_stamper_invalid_format"
# meta_type: "test"
# version: "0.1.0"
...
# entrypoint: "invalid_metadata_stamper_invalid_format.py"
...
"""
Test case for invalid format in metadata stamper.
This file is used to test that the metadata stamper properly handles invalid format.
"""
...
def get_test_file():
    ...
    return """
# Invalid format - missing metadata block markers
metadata_version: "0.1"
schema_version: "1.0.0"
name: "test"
