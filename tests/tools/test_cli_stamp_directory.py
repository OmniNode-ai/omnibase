...
def test_process_directory_recursive(stamper, temp_dir):
...
def test_process_directory_non_recursive(stamper, temp_dir):
...
def test_process_directory_include_pattern(stamper, temp_dir):
...
def test_process_directory_exclude_pattern(stamper, temp_dir):
...
def test_process_directory_ignore_file(stamper, temp_dir):
...
def test_process_directory_no_files(stamper, temp_dir):
...
def test_stamper_ignore_patterns(stamper):
...
def test_should_ignore(stamper):
