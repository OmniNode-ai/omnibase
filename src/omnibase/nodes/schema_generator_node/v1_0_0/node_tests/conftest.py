"""
Test configuration and fixtures for schema_generator_node tests.

This module provides shared fixtures and configuration for all schema_generator_node tests,
