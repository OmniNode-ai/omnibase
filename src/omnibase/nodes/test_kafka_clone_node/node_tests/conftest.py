...
# [ONEX_PROMPT] All tokens in this file must correspond to fields in ModelTestKafkaCloneContext. Ensure strong typing for all domain data (use canonical models/enums, never dict/str/list for domain data). File paths must use Path. All ONEX_PROMPT comments must be clear and actionable. All test dependencies must be injected via fixtures and protocol-first, registry-driven as per ONEX testing standards.
import pytest
