...
from omnibase.nodes.node_constants import SOURCE_TEST, TEST_EXTENSION, TEST_HANDLER_NAME
...
def test_enhanced_handler_registration_logic(handler_registry):
    class MockCustomHandler(ProtocolFileTypeHandler):
        def __init__(self, name: str = TEST_HANDLER_NAME):
            self.name = name
        ...
        @property
        def requires_content_analysis(self):
            return True
