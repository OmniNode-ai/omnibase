...
def directory(
    ...
    include: Optional[List[str]] = typer.Option(
        None, "--include", "-i", help="File patterns to include (e.g., '*.yaml')"
    ),
    exclude: Optional[List[str]] = typer.Option(
        None, "--exclude", "-e", help="File patterns to exclude"
    ),
    ...
    overwrite: bool = typer.Option(
        False, "--overwrite", "-o", help="Overwrite existing metadata blocks"
    ),
    repair: bool = typer.Option(
        False, "--repair", help="Repair malformed metadata blocks"
    ),
    force: bool = typer.Option(
        False, "--force", help="Force overwrite of existing metadata blocks"
    ),
    output_fmt: OutputFormatEnum = typer.Option(
        OutputFormatEnum.TEXT, "--format", "-f", help="Output format (text, json)"
    ),
    ...
    tree_only: bool = typer.Option(
        False, "--tree-only", help="Only process files listed in .tree (alias for tree)"
    ),
) -> int:
    """
