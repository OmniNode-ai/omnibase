...
# description: Canonical registry for event bus backends in node_parity_validator
# === /OmniNode:Metadata ===
...
from omnibase.schemas.loader import SchemaLoader  # Only import concrete here for registration
...
class RegistryTemplateNode(ProtocolNodeRegistry):
    ...
    def __init__(self, mode: ToolRegistryModeEnum = ToolRegistryModeEnum.REAL, logger: Optional[ProtocolLogger] = None, tool_collection: Optional[dict] = None):
        ...
        self.register_tool('metadata_loader', SchemaLoader)
