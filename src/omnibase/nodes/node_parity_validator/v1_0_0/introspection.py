...
from .error_codes import NodeParityValidatorErrorCode
from .models.state import ParityValidatorInputState, ParityValidatorOutputState


class NodeParityValidatorIntrospection(NodeIntrospectionMixin):
    """
    ...
    def get_metadata_loader(cls):
        if cls.metadata_loader is None:
            raise RuntimeError("NodeParityValidatorIntrospection.metadata_loader must be injected before use.")
    ...
    def get_error_codes_class(cls):
        return NodeParityValidatorErrorCode
    ...
    def get_cli_required_args(cls) -> List[CLIArgumentModel]:
        return [
            CLIArgumentModel(
                ...
                type="str",
                required=True,
                description="Required input field for node_parity_validator",
                default=None,
                choices=None,
            ),
        ]
    ...
    def get_cli_optional_args(cls) -> List[CLIArgumentModel]:
        ...
        template_args = [
            CLIArgumentModel(
                ...
                type="str",
                required=False,
                description="Optional input field for node_parity_validator",
                default=None,
                choices=None,
            ),
            CLIArgumentModel(
