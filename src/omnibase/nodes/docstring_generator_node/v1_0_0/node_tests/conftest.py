"""
Test configuration and fixtures for docstring_generator_node tests.

This module provides shared fixtures and configuration for all docstring_generator_node tests,
