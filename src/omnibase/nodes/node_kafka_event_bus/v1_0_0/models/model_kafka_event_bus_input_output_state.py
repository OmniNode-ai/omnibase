...
class ModelKafkaEventBusInputState(BaseModel):
    ...
    config: Optional[ModelKafkaEventBusConfig] = Field(default=None, description="Kafka event bus configuration (optional, overrides defaults)")
...
class ModelKafkaEventBusOutputState(BaseModel):
    ...
    output_field: Optional[ModelKafkaEventBusOutputField] = None  # Canonical output field
