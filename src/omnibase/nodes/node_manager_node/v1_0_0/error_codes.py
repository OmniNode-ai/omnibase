...
class NodeManagerErrorCode(OnexErrorCode):
    ...
    PLACEHOLDER_REPLACEMENT_FAILED = (
        "ONEX_NODE_MANAGER_024_PLACEHOLDER_REPLACEMENT_FAILED"
    )
    ...
    CONFIG_SYNCHRONIZATION_FAILED = (
        "ONEX_NODE_MANAGER_104_CONFIG_SYNCHRONIZATION_FAILED"
    )
