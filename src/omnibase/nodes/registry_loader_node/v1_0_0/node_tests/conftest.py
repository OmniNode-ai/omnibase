"""
Test configuration and fixtures for registry_loader_node tests.

This module provides shared fixtures and configuration for all registry_loader_node tests,
