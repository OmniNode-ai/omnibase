...
from omnibase.enums import OnexStatus, NodeNameEnum
from omnibase.core.core_error_codes import OnexError
from ..node_constants import CLI_ARG_AUTHOR, CLI_ARG_OUTPUT_FORMAT, CLI_ARG_FORMAT, CLI_ARG_NO_METADATA, CLI_AUTHOR_CLI_PARITY_TEST, OUTPUT_FORMAT_JSON

# Canonical protocol-facing test constants (see docs/testing.md, section 4.4)
TEST_FILE_PY_NAME = Path("test_file.py")
TEST_FILE_PY_CONTENT = '#!/usr/bin/env python3\n\ndef hello():\n    print("Hello, World!")\n'
...
class StamperBasicPythonFileTestCase(CLINodeParityTestCase):
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            setup_files={
                TEST_FILE_PY_NAME: TEST_FILE_PY_CONTENT
            },
        )
