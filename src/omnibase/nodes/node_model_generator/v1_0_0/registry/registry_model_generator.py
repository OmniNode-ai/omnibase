...
# description: Canonical registry for event bus backends in node_model_generator
# === /OmniNode:Metadata ===
...
class RegistryModelGeneratorNode(ProtocolNodeRegistry):
    """
    Canonical registry for pluggable tools in ONEX model_generator nodes.
