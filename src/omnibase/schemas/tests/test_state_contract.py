...
VALID_YAML_PATH = Path("src/omnibase/schemas/tests/testdata/valid_state_contract.yaml")
VALID_JSON_PATH = Path("src/omnibase/schemas/tests/testdata/valid_state_contract.json")
INVALID_YAML_PATH = Path(
    "src/omnibase/schemas/tests/testdata/invalid_state_contract.yaml"
)
INVALID_JSON_PATH = Path(
    "src/omnibase/schemas/tests/testdata/invalid_state_contract.json"
)
