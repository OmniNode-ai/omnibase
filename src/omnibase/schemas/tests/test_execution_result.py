...
VALID_YAML_PATH = Path(
    "src/omnibase/schemas/tests/testdata/valid_execution_result.yaml"
)
VALID_JSON_PATH = Path(
    "src/omnibase/schemas/tests/testdata/valid_execution_result.json"
)
INVALID_YAML_PATH = Path(
    "src/omnibase/schemas/tests/testdata/invalid_execution_result.yaml"
)
INVALID_JSON_PATH = Path(
    "src/omnibase/schemas/tests/testdata/invalid_execution_result.json"
)
