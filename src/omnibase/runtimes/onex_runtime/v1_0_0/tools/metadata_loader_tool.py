...
from omnibase.runtimes.onex_runtime.v1_0_0.protocols.metadata_loader_tool_protocol import MetadataLoaderToolProtocol
...
class MetadataLoaderTool(MetadataLoaderToolProtocol):
    def load_node_metadata(self, node_onex_yaml_path: Union[str, Path], event_bus) -> NodeMetadataBlock:
        ...
        return NodeMetadataBlock.from_file_or_content(node_metadata_content, event_bus=event_bus)
