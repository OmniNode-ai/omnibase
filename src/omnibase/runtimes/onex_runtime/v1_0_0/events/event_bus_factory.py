...
def get_event_bus(event_bus_type: Optional[str] = None, socket_path: Optional[str] = None, credentials: Optional[EventBusCredentialsModel] = None, mode: Optional[str] = None) -> 'ProtocolEventBus':
    """
    ...
    """
    event_bus_type = event_bus_type or os.getenv("ONEX_EVENT_BUS_TYPE", "inmemory").lower()
