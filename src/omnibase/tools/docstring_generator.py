...
def main():
    parser = argparse.ArgumentParser(description="Generate Markdown docs for all schemas.")
    parser.add_argument("--output-dir", type=str, default=str(OUTPUT_DIR), help="Output directory for Markdown docs.")
