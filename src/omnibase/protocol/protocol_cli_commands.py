...
from ..nodes.node_kafka_event_bus.v1_0_0.models.model_cli_command import ModelCliCommand
from ..nodes.node_kafka_event_bus.v1_0_0.models.state import NodeKafkaEventBusNodeOutputState
...
class ProtocolCliCommands(Protocol):
    ...
    def run_command(self, command: ModelCliCommand) -> NodeKafkaEventBusNodeOutputState:
        ...
        Returns:
            NodeKafkaEventBusNodeOutputState: The output model for the command.
        """
        ... 